var RedBox = {
  ...
  {
    this.showOverlay();
    new Effect.Appear('RB_window', {duration: 0.4, queue: {position:'end', scope:'redboxscope'}});
  ...
  showOverlay: function()
  {
    ...
    new Effect.Appear('RB_overlay', {duration: 0.4, to: 0.6, queue: {position:'end', scope:'redboxscope'}});
  },
